...
// Generated on 4/5/2026 at 4:14:40
// Library Name: MULTI_ADDER_LIB
// Block Name: multi_adder
// User Label: 
// Write Command: write_verilog ./outputs/multi_adder.routed.v
...
OA221X1_RVT U88 ( .A1 ( i[2] ) , .A2 ( n67 ) , .A3 ( copt_net_137 ) , 
    .A4 ( n66 ) , .A5 ( n69 ) , .Y ( n68 ) ) ;
HADDX1_RVT U89 ( .A0 ( copt_net_140 ) , .B0 ( n68 ) , .SO ( n41 ) ) ;
OA221X1_RVT U90 ( .A1 ( n71 ) , .A2 ( i[3] ) , .A3 ( n86 ) , .A4 ( n70 ) , 
    .A5 ( n69 ) , .Y ( n72 ) ) ;
HADDX1_RVT U91 ( .A0 ( n72 ) , .B0 ( copt_net_133 ) , .SO ( n40 ) ) ;
